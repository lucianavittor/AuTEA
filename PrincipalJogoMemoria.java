...
import JogoMemoria.ControleBtnPares;
import JogoMemoria.ModelPares;
...
public class PrincipalJogoMemoria extends JFrame {

    int clic = 0;
    JButton btnsair;
    ControleBtnPares u = new ControleBtnPares();

    List<Integer> next = u.rowsTableAll();

    public PrincipalJogoMemoria() {
    	...
    	//getContentPane().setBounds(new Rectangle(10, 10, 1350, 720));
    ...
    private void iniciarComponentes() {
        ...
        btn02.setSize(194, 214);
        btn03.setSize(194, 214);
        btn04.setSize(194, 214);
        btn05.setSize(194, 214);
        btn06.setSize(194, 214);
        btn07.setSize(194, 214);
        btn08.setSize(194, 214);

        btn02.setLocation(419, 113);
        btn03.setLocation(722, 113);
        btn04.setLocation(1025, 113);
        btn05.setLocation(116, 384);
        btn06.setLocation(419, 384);
        btn07.setLocation(722, 384);
        btn08.setLocation(1025, 384);
      ...
      //CONFIGURAÇÕES SAIR DO JOGO
        ...
        btn01.setBounds(116, 113, 194, 214);
        getContentPane().add(btn01);
    ...
    //Look and Feel
        try {
            ...
            java.util.logging.Logger.getLogger(PrincipalJogoMemoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrincipalJogoMemoria().setVisible(true);
            }
        });
    }
