	...
	private void initialize() {
		...
		btnazul.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				imagembtn3 = new ImageIcon(getClass().getResource("/images/jogo3azul.png"));
		...
		btnrosa.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				imagembtn3 = new ImageIcon(getClass().getResource("/images/jogo3rosa.png"));
		...
		btnlaranja.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				imagembtn3 = new ImageIcon(getClass().getResource("/images/jogo3laranja.png"));
		...
		btnamarelo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				imagembtn3 = new ImageIcon(getClass().getResource("/images/jogo3amarelo.png"));
		...
		btnverde.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				imagembtn3 = new ImageIcon(getClass().getResource("/images/jogo3verde.png"));
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (color == null) {
					...
					if (i == 0) {
						...
						imagembtn3 = new ImageIcon(getClass().getResource("/images/jogo3padrao.png"));
