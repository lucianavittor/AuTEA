...
public class TelaJogos extends JFrame {
	...
	private void initialize() {
		...
		btn1Colunas.setBounds(95, 36, 152, 155);
		...
		btn2Memoria.setBounds(464, 36, 152, 155);
		panel.add(btn2Memoria);

		btn3Formas = new JButton();
		btn3Formas.setBounds(835, 36, 152, 155);
		...
		lbltitulo.setBounds(120, 11, 1090, 71);
